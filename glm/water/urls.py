...
urlpatterns = [
    ...
    url(r'^live-overview/$', views.live_overview, name="live-overview"),
    url(r'^live-intake/$', views.live_intake, name="live-intake"),
    url(r'^live-pretreatment/$', views.live_pretreatment, name="live-pretreatment"),
    url(r'^live-osmosis/$', views.live_osmosis, name="live-osmosis"),
    url(r'^live-product/$', views.live_product, name="live-product"),
    url(r'^live-reject/$', views.live_reject, name="live-reject"),
    url(r'^live-energy/$', views.live_energy, name="live-energy"),
    ...
    #url live api
    url(r'^api/live-overview/$',api.live_overview_api,
        name="live-overview-api"),
    url(r'^api/live-intake/$',api.live_intake_api, name="live-intake-api"),
